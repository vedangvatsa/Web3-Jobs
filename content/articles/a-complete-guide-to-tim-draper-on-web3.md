...
ogTitle: "WHAT DOES TIM DRAPER THINK ABOUT WEB3"
description: >-
...
Fourth, he treats bitcoin as a store of value. That claim is contested because bitcoin has experienced large price swings. The [CFTC's customer advisory](https://www.cftc.gov/LearnAndProtect/AdvisoriesAndArticles/understand_the_risks_of_virtual_currency.html) warns that virtual currencies can be volatile and that cash-market platforms may lack the customer protections associated with regulated exchanges. This is not a judgment that bitcoin has no use. It is a factual warning about the risk a buyer takes when treating a volatile asset as savings.

## Blockchain businesses and Web3

Draper's activities are wider than bitcoin. Draper Associates has a [crypto and blockchain investment page](https://www.draper.vc/industries/crypto-blockchain) that says the firm invests in the sector and lists portfolio companies. That is direct evidence of the firm's declared investment focus. It is not an audited fund report and should not be used to infer returns or current valuations.
