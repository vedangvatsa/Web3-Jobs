...
ogTitle: "AGENCY VS IN-HOUSE CAREERS IN WEB3"
description: >-
...
* Like pitching ideas and presenting to external clients

**Consider in-house if you:**
* Prefer depth on one product and a longer planning horizon
* Want to see a campaign from idea to measurement over quarters
* Work well with cross-functional partners in product, sales, and support
* Value predictable ownership over constant context switching
...
* Median annual wage for marketing managers was $161,030 in May 2024. For advertising and promotions managers it was $126,960. Combined median for the group was $159,660. Source: BLS Occupational Outlook Handbook, May 2024.
* Where marketing managers work changes pay. In May 2024 the median for marketing managers was $169,840 in management of companies and enterprises, $168,210 in manufacturing, $167,610 in finance and insurance, and $165,080 in professional, scientific, and technical services. These are largely in-house heavy industries.
* For advertising and promotions managers, median pay was $160,480 in management of companies and enterprises versus $127,610 in advertising, public relations, and related services (agency-like employers). Source: BLS OOH Pay section, May 2024.
...
Pros:
* Fast skill rotation across clients and industries
* Clear briefs, defined projects, regular portfolio pieces
* Access to senior review and varied channel experts
* Faster entry without needing deep industry history

Cons:
* Divided attention across accounts, less ownership of long-term outcomes
* Hours tied to client deadlines, frequent overtime in survey data
* Pay capped by billing math at many shops, especially mid-size generalist firms
* Brand voice learning resets with each new client

**In-house**

Pros:
* Single brand focus, longer measurement window, clearer link to revenue or retention
* Closer ties to product and leadership, earlier input on strategy
* Generally higher median base pay in larger employers and tech, per BLS industry data, plus equity in some firms
* More stable planning cadence outside launch weeks

Cons:
* Narrower scope, risk of repeating similar work
* Progress depends on internal advocacy and available headcount
* Must build or buy niche expertise that an agency would already have, such as KOL vetting or on-chain attribution
* Internal process can be slow, with more approvals before shipping

Neither is better overall. The trade is breadth and speed versus depth and ownership.

## How to choose: five questions to ask

1. What do you want to learn in the next 12 months? If the answer is many channels and industries, lean agency. If it is one audience and one product, lean in-house.

2. How do you handle context switching? If three clients at once drains you, agency will be hard. If one backlog for six months bores you, in-house will be hard.

3. What compensation mix do you need now? Compare base salary, bonus, equity, and workload. Use BLS industry medians and current postings for your city, not a single national average.

4. Where is the work that builds your next role? If you need portfolio pieces with known brands, agency helps. If you need proof of strategy and sustained growth for one brand, in-house helps.

5. What is the team shape behind the job? Ask who reviews your work, who owns strategy, and what tools are available. An understaffed in-house team with no support can feel like an agency with one client.
...
## How to get started or transition

**If you target agency:**
* Build a portfolio with three finished pieces that show brief to outcome, not just visuals. Include role, constraint, and result.
* Show you can manage time across accounts. Note hours, deadlines you met, and how you handled feedback changes.
* Learn one channel well, such as paid search, SEO, or design systems, and be able to explain its limits.
* Apply to shops whose client list matches your interest. Web3 specific agencies value wallet, community, and on-chain vocabulary.

**If you target in-house:**
* Show ownership over time. Pick one project and show iteration: launch, measure, change, remeasure.
* Add business context. Connect work to revenue, activation, or retention, not just impressions or clicks.
