...
ogTitle: "AI CAREER OPPORTUNITIES AND SALARIES"
...
**Note on pay data:** Sources measure different things. The U.S. Bureau of Labor Statistics (BLS) reports base wages from employer payrolls. Sites like Levels.fyi report total compensation (base plus bonus plus annualized stock) from verified offers, which skews higher and reflects large tech employers. Glassdoor reports self-reported total pay and base ranges. Use at least two sources when you benchmark an offer, and compare base to base or total to total.

### How the market looks in 2026

A few numbers explain why these roles stay in demand.

* BLS projects U.S. employment for data scientists to grow 34 percent from 2024 to 2034, from 245,900 jobs to 328,300 jobs, adding about 82,500 positions. That is the fourth fastest growth rate in the economy. Software developers are projected to grow 15 percent and add about 267,700 jobs, the largest numerical gain among tech roles cited. Computer and information research scientists are projected to grow 20 percent. Management analysts, the BLS category closest to consultants, are projected to grow 9 percent. Source: BLS Occupational Outlook Handbook, last modified August 28, 2025; BLS Economics Daily on AI and employment 2024-34.
* PwC's 2026 Global AI Jobs Barometer, which analyzed more than one billion job ads across six continents, found jobs that require AI skills grew 69 percent since 2019 compared with 9 percent for the overall market, and workers with AI skills earned a 62 percent wage premium over peers in the same occupation.
* The World Economic Forum Future of Jobs Report 2025 projects 170 million new jobs created globally by 2030 against 92 million displaced, for a net gain of 78 million, with 22 percent of current jobs experiencing churn and about 39 percent of core skills expected to change.
* LinkedIn's 2026 labor market report found 1.3 million new AI-related jobs added in two years, including data center, annotation, and engineering roles, with AI Engineer ranked as the fastest-growing U.S. title between 2022 and 2024.

Entry-level hiring is tighter. The Stanford Digital Economy Lab found early-career roles in the most AI-exposed occupations fell about 16 percent since late 2022. That does not mean the field is closed. It means junior hiring now favors candidates who can show shipped work and the human skills PwC flags: judgment, communication, and working with stakeholders.
...
* Levels.fyi and IdeaPlan aggregations for 2026: median total compensation about $305,000 with 25th to 75th percentile about $244,000 to $390,000 at large public companies, including annualized equity. Location matters: San Francisco and San Jose medians run 15 to 20 percent above the national median in these samples.
...
* SalaryHawk, AI Safety Engineer, 1,440 verified reports including H-1B and employee data, June 2026: average base $302,046, total compensation $465,050, senior average $330,030, range $123,000 to $706,000 across levels. These higher averages reflect samples weighted to large labs and regulated tech firms.
* AI Ethics Researcher and AI Ethics Officer ranges for comparison: Neat Stack 2026 planning range $110,000 to $170,000 with median $140,000 for mid-senior ethics researchers; Jobicy AI Ethics Officer 2026 average $129,100 with junior $76,000 to $106,800 and senior up to $151,700 to $234,800; Glassdoor ethicist broad range $210,000 to $361,000 cited in industry guides, reflecting large-firm self-reports.
...
* Indeed and talent.com base-pay checks, May 2026: Indeed average base about $112,447 for 52 salaries (range about $70,454 to $179,468); talent.com average about $125,361 from about 10,000 records (entry near $99,500, experienced near $177,880).
* Design-copy synthesis of Q1 2026 postings: entry $85,000 to $110,000 base ($90,000 to $130,000 total), mid-level $120,000 to $160,000 base ($140,000 to $210,000 total), senior $160,000 to $210,000 base ($200,000 to $280,000 total), staff or principal $210,000 to $260,000 base ($280,000 to $400,000+ total). Senior bases reported for frontier labs: Google DeepMind $185,000 to $240,000, Anthropic $175,000 to $230,000, OpenAI $170,000 to $220,000.
...
* ZipRecruiter, broad national sample, June 2026: average $86,430, 25th percentile about $61,000, 75th percentile about $103,000, top 10 percent about $151,500. This sample includes many junior and generalist postings, which pulls the average down.
* AI Solutions Consultant benchmark, Orbyt, 2026: average $101,000, middle 50 percent $73,000 to $138,000 by seniority, with junior $100,000 to $120,000, mid-level $140,000 to $162,000, senior $190,000 to $215,000, principals above $260,000. Figures tied to BLS SOC 13-1111 benchmarked by level.
* Top-tier strategy and Big Four 2026 bands cited in consulting compensation guides: business analyst $120,000 to $180,000 total, associate $180,000 to $280,000, manager $280,000 to $420,000, principal or director $420,000 to $650,000, partner $700,000 to $1.5 million and higher based on book of business. Boutiques often pay 10 to 25 percent less at the same level. Hourly freelance rates in 2026 benchmarks: generalist $150 to $300 per hour, LLM and RAG architecture $200 to $400, strategy advisory $250 to $500, median across specializations about $250 per hour. Fractional engagements commonly run $15,000 to $40,000 per month.
...
**4. Ship a small portfolio and document it.**

Hiring managers screen for evidence, not course counts.

* Technical example: Build a model that predicts housing prices or customer churn. Show your data source, cleaning steps, train and test splits, metrics, error analysis, and a GitHub repo with a README that states what you built and what did not work. One complete project with a clear write-up beats three notebooks without context.
* Applied example: Create a prompt and eval library for a real task, a RAG prototype over a docs site, or an AI-assisted workflow that saves measurable time. Record the before and after, the failure cases, and the cost per task.

Both types should live where a reviewer can run or read them: GitHub, a short demo video, or a live link with instructions.
...
| AI Ethicist / AI Safety Researcher | Research scientists (federal proxy): median $140,910 base, 10th $80,670, 90th $232,120. Safety researcher samples: median base $195,000, total $322,000, middle 50 percent base $145,000 to $255,000. Safety engineer average base $302,046, total $465,050 | BLS is base only. Orbyt and SalaryHawk show base versus total | BLS OOH for SOC 15-1221 and OEWS May 2025; Orbyt and SalaryHawk June 2026 |
| Prompt Engineer | Median total about $130,000 (Glassdoor) to $175,000 (Levels.fyi), 25th $102,000 to $104,000, 75th $167,000 to $268,000, 90th $207,000 to $417,000. Base-only averages about $112,000 to $125,000 | Glassdoor and Levels.fyi are total pay. Indeed and talent.com are base only. Range reflects title drift to LLM Engineer | Glassdoor May 2026; Levels.fyi August 2026; Indeed and talent.com May 2026; DesignCopy Q1 2026 posting analysis |
| AI Consultant | BLS proxy median $101,190 base, 10th $59,720, 90th $174,140. AI consultant samples: median total $101,000 (solutions consultant benchmark) to $198,428 (Glassdoor), with large-firm bands from $120,000 (analyst) to $650,000 (principal) plus partner tiers. Freelance rates $150 to $500 per hour, median about $250 | BLS is base only. Glassdoor is total. Posted bands and freelance rates are engagement-specific | BLS OOH for SOC 13-1111; Glassdoor AI Consultant April 2025; Orbyt and consulting guides 2026 |
