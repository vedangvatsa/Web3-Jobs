...
**Where humans have the edge**- Generalization from few examples and transfer across unrelated tasks.
...
**Where AI has the edge**- Speed and consistency on pattern-heavy tasks with clear inputs, such as classifying images, transcribing speech, or drafting first passes from a template.
