...
**Install and update** Current docs at getfoundry.sh/introduction/installation use the getfoundry.sh installer:
...
**Pros**- Single-language workflow. You stay in Solidity for contracts, tests, and scripts, which reduces mental switching and keeps logic next to the code it tests.
