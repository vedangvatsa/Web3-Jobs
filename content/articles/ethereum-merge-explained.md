...
In normal operation a transaction is included in a block within a slot, then justified and finalized across two epochs, about 12.8 minutes from the epoch boundary. Finalized means the protocol would need to burn at least one-third of staked ETH to revert it. Apps that need strong settlement wait for finalized.**Where can I verify this?**
