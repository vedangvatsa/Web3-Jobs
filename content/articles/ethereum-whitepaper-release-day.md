...
In late 2013, a young programmer and writer for *[Bitcoin](/what-is-bitcoin) Magazine* named Vitalik Buterin quietly released a document that would change the course of the internet. The [Ethereum](/what-is-ethereum) whitepaper, titled "A Next-Generation [Smart Contract](/what-are-smart-contracts) and Decentralized Application Platform," was not just an iteration on Bitcoin; it was a radical leap forward. While Bitcoin had brilliantly solved the problem of decentralized money, Buterin envisioned something far more ambitious: a decentralized, programmable platform that could run any application imaginable. This was the concept of the "world computer," a single, global [blockchain](/what-is-a-blockchain) that could serve as the foundation for a new, user-owned internet, or [Web3](/what-is-web3).
...
-   **Financial Derivatives and Stablecoins:** Buterin described how smart contracts could be used to create complex financial instruments and [tokens](/what-is-a-token) pegged to the value of real-world assets. This was the theoretical foundation for what would become the [DeFi](/what-is-defi) ecosystem.
...
-   **Decentralized Autonomous Organizations (DAOs):** Buterin laid out the concept of a "decentralized autonomous corporation," an organization that could run entirely on code, with its rules and governance encoded in smart contracts. This was the birth of the [DAO](/what-is-a-dao) concept.
