...
**Tokenization Process:** Ownership shares of the LLC are transformed into digital tokens on a blockchain, such as ERC-20 tokens on [Ethereum](/what-is-ethereum).
3.

**Trading Mechanism:** These tokens can be traded on decentralized exchanges, enabling fractional ownership and enabling near-instant settlement.
