...
ogTitle: "FUTURE OF WEB3 ARCHITECTURE"
...
However, trust poses a challenge: verifying that an AI made decisions based on the claimed model and inputs rather than a modified version. Enter **verifiable AI inference**. Projects like

**Giza** and

**Modulus Labs**(acquired by Aztec in 2024) are leading zero-knowledge proofs for machine learning models. These cryptographic proofs confirm that a specific model, when executed with specific inputs, yields a specific output. This process allows smart contracts to use AI outputs without needing a centralized oracle or trusted execution environment.
