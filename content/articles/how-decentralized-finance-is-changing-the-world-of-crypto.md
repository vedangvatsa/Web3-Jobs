...
1.**Decentralized Exchanges (DEXs):**-**Description:**Protocols like Uniswap enable peer-to-peer trading of assets without relying on a central order book.
...
2.**Lending and Borrowing Protocols:**-**Description:**Protocols such as Aave and Compound establish decentralized money markets.
...
3.**Stablecoins:**-**Description:**Cryptocurrencies like USDC are pegged to the value of real-world assets, typically the US dollar.
