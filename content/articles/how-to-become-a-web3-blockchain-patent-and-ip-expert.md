...
- **Patent Prosecution:** Working with engineering teams to understand their inventions and drafting patent applications to be filed with patent offices.
- **IP Licensing:** Drafting and negotiating licensing agreements for the use of a project's technology or brand.
- **NFT and Digital Asset Law:** Advising creators and platforms on the complex legal issues surrounding [NFTs](/what-are-nfts) and digital ownership.
- **Open-Source Strategy:** Helping projects choose the right open-source licenses for their code to encourage collaboration while protecting their core IP.
