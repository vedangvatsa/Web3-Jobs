...
-   **Learn Common Vulnerabilities:** You need an encyclopedic knowledge of common attack vectors. This includes [reentrancy](/understanding-reentrancy-attacks-in-web3-smart-contracts), integer overflows, oracle manipulation, and access control issues.
...
-   **Formal Verification:** For senior roles, an understanding of [formal verification](/how-formal-verification-improves-smart-contract-security) tools like Certora is a major advantage.
