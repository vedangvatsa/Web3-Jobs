---
title: "How to Build a Web3 Resume for Maximum Impact"
...
-   **Key Links (Must be hyperlinked):** This is the most critical part of the header.
    ...
    -   **ENS Address (e.g., `yourname.eth`):** Include your Ethereum Name Service address. This is a powerful cultural signal that you are an active user of the ecosystem.
...
-   **NFT Marketplace (Personal Project)** `[Link to GitHub]` `[Link to Demo]`
    -   Designed and deployed a gas-efficient ERC-721 smart contract using Foundry, achieving 99% test coverage.
    -   Built a React frontend with Viem that allowed users to mint NFTs and view their collections.
...
-   **Web2 Role:** *Project Manager at a SaaS company.*
    ...
    -   *Web3 Translation:* "Led a cross-functional, remote-first squad of 5 engineers in an agile environment, shipping 3 major product features that increased user engagement by 15%." (Highlights remote work, agile, and quantifiable impact).
