...
**Diligence**: Analysts lead thorough investigations to evaluate a project's viability. This includes:
...
**Investment Memo Writing**: This document encapsulates the findings from the diligence process. It must present a clear, concise, and evidence-based argument for or against making an investment.
...
**Become a "Degen" and User**: Gain first-hand experience with the products you will evaluate.
2.

**Develop a Public Profile**: Establish yourself as an expert in a niche area. Start a blog, newsletter, or Twitter account to publish high-quality research in subjects like zero-knowledge proofs, MEV, or specific L1 ecosystems.
3.

**Build a [Portfolio](/building-web3-portfolio) of Public Work**: Your public analyses serve as your resume.
...
**Network Strategically**: Cultivate relationships with analysts and associates at funds you admire. Instead of merely asking for a job, request feedback on your analyses.
