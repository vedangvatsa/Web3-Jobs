...
Performance Improvement Plans have a bad reputation because most of them are just documentation for a firing that's already been decided. That's a waste of everyone's time.
...
This isn't about building a legal case (though it helps with that too). Documentation protects both you and the employee.

Write down the specific issues you've observed, dates, and any impact on the team. Record the conversations you've had and what was agreed on. Keep copies of the PIP and check-in notes. If you're using a tool like Notion, Confluence, or even a shared Google Doc, keep it updated.

Good documentation also forces you to be honest with yourself. If you can't write down a clear, specific performance concern, maybe the problem isn't as concrete as you thought.
