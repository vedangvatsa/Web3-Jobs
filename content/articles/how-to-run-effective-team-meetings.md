...
1.**To make a decision.**2.**To solve a problem through discussion and brainstorming.**A meeting should never be purely for status updates. That information can and should be shared asynchronously (e.g., via email, Slack, or a project management tool).
...
-**Identify Key Roles:**-**The Decider:**Who is the person that ultimately has the authority to make the final decision? They must be in the room.
...
1.**A list of the key decisions that were made.**2.**A clear list of action items, with the owner and due date for each.**
