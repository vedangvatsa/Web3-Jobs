...
What happens next is undecided. Kelp has not disclosed whether it is in contact with the bot operator or what it expects to occur when the 24-hour pause lifts. Cointelegraph said it had contacted Blockaid and Kelp for additional comment but had received no response by publication.
