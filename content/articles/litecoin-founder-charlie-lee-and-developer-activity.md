...
- Continued merchant adoption (many merchants accept LTC).
- Network security (significant value of hashrate securing the network).
- Market capitalization (consistently among the top cryptocurrencies).
...
Ethereum aims to be a platform, innovative, experimental, and rapidly evolving.  
