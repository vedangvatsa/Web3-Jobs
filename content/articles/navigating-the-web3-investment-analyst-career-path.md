...
2.  **Diligence:** Once a promising project is found, the analyst leads the deep-dive investigation to assess its viability.
    ...
    *   **Technical Diligence:** How does the protocol work? Is the architecture sound? What are the security risks? This often involves reading the whitepaper and even diving into the smart contract code on GitHub.
    *   **Tokenomics Analysis:** What is the utility of the token? Is the distribution fair? What are the mechanisms for value accrual? This requires a strong understanding of economic incentives.
...
### 3. How is it different from a traditional VC analyst?
