...
**Diligence**: After uncovering a promising project, the analyst leads a thorough investigation to evaluate its viability.
...
**Investment Memo Writing**: The diligence process results in the investment memo, a detailed document that articulates the rationale for or against an investment. This document must present a clear, concise, and data-driven argument and often represents the analyst's most significant work.

4.

**Portfolio Support**: Following an investment, analysts frequently assist portfolio companies with various aspects, including recruitment, marketing, and connecting them with other partners.
...
**Become a "Degen" and a User**: First-hand experience with the products you will evaluate is invaluable.
2.

**Develop a Public "Spike"**: Establish yourself as an expert in a specific niche by creating a blog, newsletter, or Twitter account where you publish high-quality research on topics like zero-knowledge proofs, MEV, or a specific Layer 1 ecosystem.
3.

**Build a Portfolio of Public Work**: Your analyses act as your [resume](/how-to-build-a-web3-resume-that-stands-out).
