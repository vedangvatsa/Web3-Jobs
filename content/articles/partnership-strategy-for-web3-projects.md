...
### 1. How is Web3 business development different from traditional sales?
Web3 BizDev is about creating **positive-sum partnerships and integrations**, not making direct sales. The focus is on collaboration and ecosystem growth rather than transactional customer relationships. It requires deep technical and ecosystem knowledge. Learn more in our [full BizDev career guide](/web3-business-development-career-guide).

### 2. What is a "partnership thesis"?
A partnership thesis is a clear, strategic statement about which types of integrations will create the most value for your project. It's a data-driven plan that guides your outreach efforts, ensuring you focus on the highest-leverage opportunities.

### 3. What is the most effective way to initiate a partnership discussion?
A **warm introduction** from a trusted mutual contact (like a shared investor) is always the most effective method. If you must send a cold message, it needs to provide specific, insightful value upfront. Read our guide on [how to cold contact someone](/how-to-cold-contact-and-get-a-response) for a detailed framework.

### 4. What does a typical Web3 partnership "deal" look like?
It often doesn't involve direct cash payments. Common deal structures include **co-marketing campaigns**, **technical integrations**, **fee-sharing agreements** from the revenue generated by the integration, or **token swaps** between project treasuries to align long-term incentives.

### 5. What is the most important trait for a Web3 BizDev professional?
**A strong, trustworthy reputation.** The Web3 space is small and relationship-driven. Your reputation for being helpful, knowledgeable, and reliable is your most valuable asset and will lead to the best opportunities.