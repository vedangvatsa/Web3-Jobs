...
### Deploy as on Ethereum where possible
...
### Plan for sequencer and validator liveness
...
### Choose CDK versus public chain deliberately
...
Longer than a normal transfer. You must wait for Heimdall to submit the checkpoint that contains your burn or exit transaction, then you submit a proof against the contracts on Ethereum. Milestones do not replace checkpoints for this path. Allow minutes to hours depending on checkpoint interval and Ethereum load.**Do I need POL to use Polygon?**
