...
1.  **Sense:** The agent perceives its environment. This could be reading a web page, analyzing market data, or checking the status of a smart contract.
...
3.  **Act:** The agent takes an action. This could be clicking a button on a website, executing a code script, sending an email, or submitting a transaction to a blockchain.
