...
A standard token grant for a full-time team member typically includes the following components, mirroring traditional startup equity structures.**1. Grant Size**-**Definition:**The total number of tokens allocated to the individual, often expressed as a monetary value at the time of the grant and as a percentage of the total token supply.
-**Considerations:**The grant size should be competitive and reflect the individual's role, experience, and potential contributions to the project. Senior engineers and leadership roles usually receive the largest grants. Establishing a clear "leveling framework" ensures fairness and consistency across the team.**2. Vesting Schedule**-**Definition:**The timeline over which the employee earns their tokens. A common vesting schedule in both Web2 and Web3 is**4 years**, meaning the employee earns their full grant over that period.
-**Importance:**Vesting encourages long-term commitment. If an employee leaves before their tokens are fully vested, they forfeit the unvested portion, aligning their financial interests with the protocol's success.**3. Cliff**-**Definition:**A "cliff" is an initial period during the vesting schedule when no tokens vest. If the employee departs before this period concludes, they do not receive any tokens. The industry standard is a**1-year cliff**.
...
-**Vesting Schedule:**4 years with a 1-year cliff.**Vesting Breakdown:**| Timeline | Tokens Vested | Total Tokens Owned |
|----------|------------------|--------------------|
...
Clear communication is vital for both companies and candidates regarding token-based compensation.**For Companies:**-**Transparency:**Offer candidates detailed documentation on tokenomics, vesting schedules, and the network's current and fully diluted valuation.
-**Risk Disclosure:**Clearly explain the token's volatility, helping candidates understand that the value of their grant can fluctuate.**For Candidates:**-**Inquire Thoroughly:**Focus on more than just the current value. Ask about the vesting schedule, total token supply, and the percentage of the network represented by your grant.
