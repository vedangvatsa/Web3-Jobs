...
This article examines Ethereum rollups in detail. It discusses the fundamental principles underlying this vital scaling technology, contrasts the two primary types,**Optimistic Rollups** and

**Zero-Knowledge (ZK) Rollups**, and evaluates their impact on the [Web3](/what-is-web3) ecosystem.
...
Optimistic Rollups, such as

**Arbitrum** and

**Optimism**, function under a security model characterized by "innocent until proven guilty."
...
A landmark upgrade in this context was
...
The long-term vision includes full

**Danksharding**, which will further enhance the dedicated data space for rollups, potentially enabling the Ethereum ecosystem to scale to millions of transactions per second across a active ecosystem of thousands of rollups.
