...
**Governor contract**, which manages the proposal lifecycle, including proposal creation, voting, and execution.
 - The **[Token](/what-is-a-token) contract**, used to determine voting power among stakeholders.
 - The

**Timelock contract**, which enforces a delay between a vote passing and the execution of its code, allowing communities to respond to potentially harmful proposals.
- **Off-Chain Voting Systems:** They connect the DAO with gasless, off-chain voting platforms like

**Snapshot**, used for "temperature check" polls and community signaling.
...
- **DAO Frameworks:** Familiarity with standard governance frameworks like

**OpenZeppelin Governor** and
...
**Develop a [Portfolio](/building-web3-portfolio) Project:**
