...
A Web3 DevRel is a hybrid professional, a unique blend of engineer, educator, marketer, and community builder. Their primary mission is to champion the needs of developers and make it as easy and enjoyable as possible for them to build on their protocol. They are the voice of the developer within the core team, and the voice of the protocol to the external developer community. For more, see our [guide to the Web3 DevRel role](/what-is-a-web3-devrel-engineer).
...
3.  **Product Feedback Loop:**
    ...
    -   **Improving the Developer Experience (DX):** They identify pain points in the developer experience and advocate for improvements to the protocol's APIs, SDKs, and documentation.
