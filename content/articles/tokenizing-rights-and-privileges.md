...
In a [DAO](/what-is-a-dao), a governance token is more than just an asset; it's a right to participate in the decision-making process of the protocol.
...
-   **Practical Insight:** This is the core idea behind [Decentralized Identity (DID)](/decentralized-identity-explained). It creates a user-owned identity where you control your own credentials and can prove things about yourself without relying on a central authority.
