...
ENS functions similarly to the

**Decentralized Name System (DNS)** used on the internet. Just as DNS translates memorable domain names (such as `google.com`) into complex IP addresses, ENS translates memorable `.eth` names into Ethereum addresses.
