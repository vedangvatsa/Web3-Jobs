...
- **Primary Skills:** Mastery of

**React**(or similar frameworks) and

**TypeScript**. They must also understand libraries like

**Ethers.js** or

**Viem** to connect frontends to user wallets and smart contracts.
- **Core Focus:** Crafting an intuitive, secure user experience while simplifying blockchain complexities.

### 3. Protocol Engineer

Protocol engineers play an important role in building the blockchains themselves, Layer 1 and Layer 2 networks that support dApps.

- **Primary Skills:** Expertise in low-level systems languages like

**Rust** or

**Go**. A strong academic background in computer science, particularly in distributed systems and cryptography, is often required.
...
- **Primary Skill:** Mastery of

**SQL** for querying decoded blockchain data on platforms like Dune Analytics.
