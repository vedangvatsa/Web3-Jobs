...
Indonesia's crypto environment is shaped by its user demographics, highlighting the need for accessible technologies.
...
**Key Urban Hubs **| While the workforce is widespread,** Jakarta**stands as the main hub for business and finance, while

**Bali** attracts crypto nomads and remote workers. |

### In-Demand Roles and Salary Expectations

The Web3 job market in Indonesia is expanding, with competitive salaries often exceeding those in traditional tech sectors. However, these salaries typically remain below global averages. The lower cost of living outside Jakarta enhances the appeal of these roles.
...
**Community Manager (Bahasa Indonesia)**| 15,000,000 - 35,000,000+ | N/A |
|

**Marketing Manager**| 20,000,000 - 45,000,000+ | N/A |

### How to Secure a Web3 Job in Indonesia

1.

**Achieve Fluency in Bahasa Indonesia**: Proficiency in the local language is essential for community-facing, marketing, or support roles. This skill gives local talent a significant edge and is a critical requirement for international firms.

2.

**Emphasize Mobile and Gaming Experience**: Showcase any background in mobile app development or the gaming sector. Demonstrate an understanding of crafting products for a mobile-first audience and express enthusiasm for Web3 gaming.

3.

**Create a Community-Focused [Portfolio](/building-web3-portfolio)**: For non-technical roles, your portfolio should highlight community engagement.
 - **Manage a Gaming Guild**: Establish and oversee a local gaming guild. Document its growth and your management process.
...
**Engage with Local Communities**: Build connections with key players in Jakarta and Bali. Attend local meetups and crypto events to expand your network. The Indonesian Web3 environment thrives on social interactions and relationships.
