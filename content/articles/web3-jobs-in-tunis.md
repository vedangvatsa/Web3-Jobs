...
**Salary Guide: Web3 Jobs in Tunis**### Local Opportunities
...
**Months 1-4: Solidity Fundamentals + Security**- Set up GitHub, Twitter, and LinkedIn; enroll in Alchemy University and CryptoZombies.
...
- Contribute to open-source Solidity projects such as OpenZeppelin and Uniswap v4.

**Deliverable:** 4-5 GitHub repositories, 1-2 open-source contributions, 500+ Twitter followers, 1 published security analysis.

**Months 5-9: Specialization in DeFi Architecture**- Build two sophisticated projects: an AMM protocol and a lending protocol.
...
**Months 10-14: Secure a Senior Role**- Apply to major protocols like Aave and Uniswap.
...
**Months 15-18: Establish Thought Leadership**- Become recognized as a top DeFi developer.
- Pursue senior engineer or tech lead roles with higher-end compensation.

**Quick Wins:**- Identify security vulnerabilities on Immunefi; earn competitive bounties.
...
**Months 1-4: React + Web3.js Fundamentals**- Master React (hooks, state management, optimization).
- Learn Web3.js and ethers.js; build basic dApps.
- Create a portfolio with a simple wallet, DEX interface, and NFT viewer.

**Deliverable:** 3 shipped dApps, 500+ Twitter followers.

**Months 5-8: Develop Full Production Projects**- Build a full-featured DEX interface and a lending protocol UI with analytics.
- Contribute to open-source Web3 UI libraries.
- Network with over 20 frontend Web3 developers.

**Deliverable:** 2 production-quality projects, 1-2 open-source contributions, 1,500+ Twitter followers.

**Months 9-12: Land a Full-Time Role**- Target protocols seeking strong frontend engineers.

**Expected Salary:** Competitive compensation.

**Months 13-14: Specialize Further**- Gain deep expertise in specific protocol architecture.

**Expected Compensation:** Competitive salary.

**Quick Wins:**- Create an open-source Web3 UI library and attract sponsorship from major protocols.

#### Path 3: Protocol Engineer & Core Infrastructure Specialist (12-20 Month Timeline)

**Months 1-6: Learn Rust/Go + Layer 2 Architecture**- Study Layer 2 solutions and master Rust (or Go).
- Build infrastructure projects such as a light client or custom EVM.

**Deliverable:** 2-3 infrastructure projects demonstrating recognized expertise.

**Months 7-12: Contribute to Major Projects**- Collaborate with projects like Arbitrum and Optimism.
- Publish research on Ethereum scaling.

**Deliverable:** 3+ merged PRs in major protocols, 2,000+ Twitter followers in the infrastructure community.

**Months 13-18: Secure a Core Team Role**- Apply to leading organizations like the Ethereum Foundation.

**Expected Salary:** Competitive compensation plus equity.

**Months 19-20: Achieve Thought Leadership**- Gain recognition as a core protocol engineer.

**Quick Wins:**- Report bugs in major Layer 2 projects and earn competitive bounties.
...
**Week 1-2:**- Set up professional GitHub, Twitter, and LinkedIn profiles.
- Enroll in Alchemy University and CryptoZombies.
- Join five Solidity/Web3 Discord communities and participate actively.
- Start tweeting three times a week about your learning progress.

**Week 3-4:**- Complete the first two modules of Alchemy and deploy testnet contracts.
...
- Network with 30 Web3 developers on Twitter and LinkedIn.

**Week 5-6:**- Build and deploy your first mainnet project on Polygon or Optimism.
...
- Begin your first competitive audit on Code4rena.

**Week 7-8:**- Create a second, more complex project (AMM, lending, NFT).
- Publish a technical Twitter thread detailing your project.
- Join Upwork and apply for five smart contract development gigs.
- Conduct informational interviews with five contacts you reached out to.

**Week 9-10:**- Publish a third article focused on technical research or market analysis.
...
**Week 11-12:**- Contribute to an open-source project with the goal of one merged PR.
...
Staying in Tunisia is advisable, particularly due to the savings from remote work. Build your wealth locally before considering relocation.

#### How do I network with top Web3 developers?

Engage on Twitter, contribute to open-source projects, and participate in conferences. Networking in person yearly can also create valuable connections.

#### What Web3 companies are hiring Tunisians?

Numerous protocols and startups are actively hiring, including Aave, Uniswap, and Compound. Explore crypto job boards to discover opportunities.
...
Engage with the community on Twitter, contribute to open-source projects, and participate in mentorship-focused programs like Encode Club.
