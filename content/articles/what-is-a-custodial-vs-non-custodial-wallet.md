...
When you create a non-custodial wallet, you are given a **[seed phrase](/what-is-a-seed-phrase-and-why-it-matters)** (also called a secret recovery phrase), which is a list of 12 or 24 random words. This seed phrase is the master key that can be used to generate all the private keys in your wallet.
...
- **Software Wallets (Hot Wallets):** [MetaMask](/what-is-a-browser-extension-wallet), Rabby, Phantom. These are browser extensions or mobile apps.
- **Hardware Wallets (Cold Wallets):** [Ledger](/understanding-hardware-wallets-for-crypto-security), Trezor. These are physical devices that keep your private keys completely offline, offering the highest level of security.
