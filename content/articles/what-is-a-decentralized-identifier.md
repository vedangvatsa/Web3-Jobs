...
**The Scheme:**`did:` indicates the identifier as a DID.
2.

**The DID Method:**`example:` denotes the specific [blockchain](/what-is-a-blockchain) or Distributed Ledger Technology (DLT) hosting the DID's records. Various methods exist, including `did:ethr:` for [Ethereum](/what-is-ethereum) and `did:btcr:` for [Bitcoin](/what-is-bitcoin).
3.

**The Method-Specific Identifier:**`123456789abcdefghi` represents a unique string generated by the DID method, often derived from a cryptographic public key.

### The DID Document: The "Business Card"

A DID functions as an address until it connects to a

**DID Document**. This JSON file linked to the DID contains essential information:
