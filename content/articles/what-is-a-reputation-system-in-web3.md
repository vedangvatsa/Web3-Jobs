...
**Verifiable Credentials and Attestations:** Tamper-proof claims made about a user's wallet by other entities. Examples include:
...
**Social Graph Analysis:** By examining a user's connections on decentralized social platforms like Farcaster or Lens, reputation systems can infer trustworthiness. A user followed by multiple reputable accounts will likely see their reputation score rise.

4.

**Governance Participation:** Active and informed voting history in [DAOs](/what-is-a-dao) indicates a user's commitment and expertise within an ecosystem.
