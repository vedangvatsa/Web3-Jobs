...
**Mechanics of Liquidity Provision:** 1. A user, referred to as a

**Liquidity Provider (LP)**, deposits a pair of tokens, such as [ETH](/what-is-ethereum) and USDC, into a liquidity pool on a DEX like Uniswap.
...
**Example of a Yield Farming Loop:** 1. Provide liquidity to the ETH/USDC pool on Uniswap and receive ETH/USDC LP tokens, earning trading fees from Uniswap in the process.
