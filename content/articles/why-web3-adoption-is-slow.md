...
> **The Solution:** [Account Abstraction (EIP-4337)](/account-abstraction-explained) is seen as a key part of the solution, promising to enable features like social recovery (no more seed phrases) and gasless transactions, making a Web3 wallet feel more like a familiar Web2 account.
...
- **Layer 2 Solutions:** While [Layer 2s (L2s)](/guide-to-layer-2s) like Arbitrum and Optimism have dramatically improved transaction speeds and costs, they add another layer of complexity for users, who have to "bridge" their assets between different networks.
...
- **Potential Candidates:** Many believe this "killer app" will come from areas like [Web3 gaming](/exploring-web3-gaming) (true ownership of in-game items) or [decentralized social media (SocialFi)](/what-is-socialfi), but no single application has broken through to the mainstream yet.
