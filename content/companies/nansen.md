...
Nansen is a blockchain analytics platform that labels over 250 million wallets across multiple chains, providing real-time dashboards, smart money tracking, and on-chain intelligence for traders, funds, and protocols.

## Open Positions

Nansen currently has **3 open positions** listed on HashtagWeb3.com across engineering, product, marketing, and operations roles.

## Sources

Information compiled from publicly available sources about Nansen.
