...
6. Miner earns block reward + transaction fees
...
2. Network pseudo-randomly selects validators to propose blocks
...
4. With enough rounds, network reaches consensus
