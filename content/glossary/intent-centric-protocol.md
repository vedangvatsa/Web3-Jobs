...
description: >-
  Intent-centric protocols are blockchain systems where users express desired
  outcomes (intents) rather than specifying exact transactions. Specialized
  solvers compete to fulfill intents optimally, abstracting complexity and
  enabling better execution, cross-chain coordination, and MEV protection.
relatedTerms:
  - cross-chain
  - mev
  - solver
