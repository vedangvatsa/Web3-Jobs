...
**Liquidation cascades** are chain reactions where one liquidation triggers others. Black Thursday 2020: ETH dropped 30%, triggered liquidations on Aave. Liquidations forced asset sales, pushed prices lower, triggered more liquidations. Vicious cycle. Cascade resulted in $130M+ in bad debt across protocols. Liquidation cascades are systemic risk in DeFi. Interconnected lending protocols mean liquidations cascade across systems. Understanding cascade risks is critical for protocol design. Preventing cascades is major challenge for DeFi risk management.
