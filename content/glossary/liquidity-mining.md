...
**Liquidity mining** rewards users for providing liquidity. Uniswap distributes UNI tokens to liquidity providers on incentivized pools. Aave distributes AAVE tokens to suppliers and borrowers. Users deposit tokens into pools earning trading fees + token rewards. Liquidity mining jumpstarts new protocols—without mining rewards, why provide liquidity? Mining attracts capital quickly. 2020 DeFi summer was driven by liquidity mining craze. Yield Farming Yolo (YFY) earned 1000%+ APY through mining. Mining can be unsustainable—when rewards end, liquidity dries up. Mining is powerful but temporary tool for attracting users.
