...
**Transaction finality** is when transaction becomes irreversible. Bitcoin: after 6 blocks (60 minutes), transaction essentially final. Ethereum: after ~12 minutes (66 blocks), high economic finality. Different finality models exist. Probabilistic finality: probability increases with blocks. Absolute finality: cryptographic guarantee. Economic finality: economic penalty for reversal. Understanding finality is critical for risk assessment. High-value transactions require waiting for finality. Low-value transactions can accept less finality. Finality tradeoff between certainty and speed.
