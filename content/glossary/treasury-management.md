...
**Treasury management** refers to protocols managing their cryptocurrency reserves. Uniswap has $2B+ in treasury (held in UNI, ETH, stablecoins). Through governance voting, UNI holders decide how to allocate treasury—grants to developers, liquidity provisioning, token buybacks, etc. Treasury management is critical for protocol sustainability. Poor management (misallocation, bad investments, theft) can destroy protocols. Good management enables sustained development, incentivization, and growth. Treasury management combines finance, governance, and strategic planning.
