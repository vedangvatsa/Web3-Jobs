...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/agentic-payments-onchain', destination: '/agentic', permanent: true },
      { source: '/connect-by-cointelegraph-seoul-edition', destination: '/connect', permanent: true },
      { source: '/korea-blockchain-week-kbw2026', destination: '/korea', permanent: true },
      { source: '/korea-blockchain-week-networking-rooftop', destination: '/korea', permanent: true },
