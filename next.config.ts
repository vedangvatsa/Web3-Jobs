...
const nextConfig: NextConfig = {
  ...
  async headers() {
    const cspHeader = `
      ...
      img-src 'self' blob: data: https://images.unsplash.com https://picsum.photos https://fastly.picsum.photos https://i.picsum.photos https://s.w.org https://assets.ns.com;
      font-src 'self' data:;
      object-src 'none';
      base-uri 'self';
      form-action 'self';
