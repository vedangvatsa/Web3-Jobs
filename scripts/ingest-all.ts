...
const GLOBAL_ECOSYSTEM_FEEDS: FeedConfig[] = [
  ...
  { company: 'Grayscale',      type: 'greenhouse', slug: 'grayscale',    url: 'https://boards-api.greenhouse.io/v1/boards/grayscale/jobs?content=true',    skills: ['Web3','Blockchain','Crypto','DeFi','Infrastructure'] },
