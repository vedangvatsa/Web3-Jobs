...
async function main() {
  ...
  const web3 = await processFile('LOCAL_PATH/jobs-extracted.csv', 7, 'Web3 Jobs');
  ...
  fs.writeFileSync('LOCAL_PATH/scripts/_country_data.json', JSON.stringify({ cvin: cvin.countries, web3: web3.countries, cvinTotal: cvin.total, web3Total: web3.total }, null, 2));
}
