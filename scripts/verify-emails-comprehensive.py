...
OUTPUT_FILE = "LOCAL_PATH/scripts/iimjobs-verified-final.json"
REJECTED_FILE = "LOCAL_PATH/scripts/iimjobs-rejected.json"
REPORT_FILE = "LOCAL_PATH/scripts/iimjobs-verification-report.json"
