    ...
    <div className="site-container page-section">
     <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
      ...
      <article className="flex-1 min-w-0 max-w-4xl">
       ...
       {/* Rendered content */}
       <div
        className="prose prose-neutral dark:prose-invert max-w-none prose-headings:font-semibold prose-headings:tracking-tight prose-h2:text-2xl prose-h2:mt-10 prose-h2:mb-4 prose-h3:text-xl prose-h3:mt-8 prose-h3:mb-3 prose-p:leading-7 prose-p:mb-4 prose-li:leading-7 prose-strong:font-semibold prose-a:text-primary prose-a:no-underline hover:prose-a:underline prose-code:bg-muted prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-code:text-sm [--tw-prose-pre-code:hsl(var(--foreground))] prose-pre:bg-muted prose-pre:text-foreground prose-pre:border prose-pre:rounded-lg [&_pre_code]:text-foreground [&_svg]:mx-auto [&_svg]:my-8 [&_svg]:block [&_.diagram]:my-8 [&_.diagram]:p-6 [&_.diagram]:bg-muted/30 [&_.diagram]:border [&_.diagram]:rounded-lg [&_.callout]:my-6 [&_.callout]:p-4 [&_.callout]:border-l-4 [&_.callout]:border-primary [&_.callout]:bg-primary/5 [&_.callout]:rounded-r-lg [&_.comparison-table]:my-8 [&_.comparison-table_table]:w-full [&_table]:w-full [&_table]:border-collapse [&_th]:text-left [&_th]:p-3 [&_th]:border-b-2 [&_th]:font-semibold [&_td]:p-3 [&_td]:border-b"
