  ...
  return (
    <div
      className={cn(
        ...
        "prose-pre:bg-zinc-950 dark:prose-pre:bg-zinc-900/60 prose-pre:border prose-pre:border-zinc-200 dark:prose-pre:border-zinc-800/40 prose-pre:rounded-xl",
        ...
        // Images
        "prose-img:rounded-xl prose-img:shadow-sm prose-img:border prose-img:border-zinc-200 dark:prose-img:border-zinc-800/40",
        // HR
