 ...
 return (
  <div
   className={cn(
    ...
    "prose-h2:text-2xl prose-h2:sm:text-3xl prose-h2:font-bold prose-h2:mt-10 prose-h2:mb-5",
    "prose-h3:text-xl prose-h3:sm:text-2xl prose-h3:font-bold prose-h3:mt-8 prose-h3:mb-4",
    ...
    "prose-blockquote:border-l-2 prose-blockquote:border-zinc-900 dark:prose-blockquote:border-zinc-100 prose-blockquote:pl-6 prose-blockquote:py-2 prose-blockquote:my-6 prose-blockquote:not-italic",
    "prose-blockquote:text-lg prose-blockquote:sm:text-xl prose-blockquote:text-zinc-800 dark:prose-blockquote:text-zinc-200 prose-blockquote:leading-relaxed",
    // Images
    "prose-img:rounded-lg prose-img:shadow-sm prose-img:border prose-img:border-zinc-200 dark:prose-img:border-zinc-800/40",
    // HR
    "prose-hr:border-zinc-200 dark:prose-hr:border-zinc-800/50 prose-hr:my-8",
    className
   )}
