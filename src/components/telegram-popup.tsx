...
export function PromoPopup() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <div className="absolute inset-0 bg-foreground/40" onClick={dismiss} aria-hidden="true" />
      <div
      ...
      >
        ...
        <p id="promo-popup-title" className="pt-1 text-center text-lg font-semibold tracking-tight text-foreground">
