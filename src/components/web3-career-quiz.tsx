...
export function Web3CareerQuiz() {
  ...
  if (showResult && result) {
    const shareText = encodeURIComponent(
      `I took the Web3 Archetype Assessment and my result is: ${result.archetype}! Find out your Web3 personality:`
    );
    ...
    return (
      <div className="max-w-2xl mx-auto w-full quiz-result-enter">
        <Card className="text-center shadow-sm border-primary/20">
          ...
          <CardFooter className="flex-col gap-4 !pt-6">
            ...
            <CtaBanner
              ...
              description="Now that you know your archetype, find the perfect job on our Telegram channel with over 60,000 subscribers."
            ...
            <p className="text-xs text-muted-foreground pt-4">
              This is a fun guide, not definitive career advice. Explore all roles to find your true passion!
            </p>
          </CardFooter>
        </Card>
      </div>
    ...
    <div className="max-w-2xl mx-auto w-full">
      <Card className="shadow-sm">
        <CardHeader>
          ...
          <CardDescription>
            Discover your Web3 personality archetype and the roles that match.
          </CardDescription>
          <Progress value={progress} className="w-full pt-2" />
        </CardHeader>
        <CardContent>
          <div key={currentQuestionIndex} className="quiz-question-enter">
