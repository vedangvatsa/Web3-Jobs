...
const articles: Article[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'image', src: 'https://placehold.co/800x450.png', alt: 'Two people at an interview desk', 'data-ai-hint': 'interview job', caption: 'Preparation and passion are your best assets in a Web3 interview.' },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'image', src: 'https://placehold.co/800x450.png', alt: 'A resume document with a GitHub logo', 'data-ai-hint': 'resume document', caption: 'Your resume should be a gateway to your on-chain and public contributions.' },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'image', src: 'https://placehold.co/800x450.png', alt: 'A futuristic, fast-moving cityscape', 'data-ai-hint': 'futuristic cityscape', caption: 'The Solana ecosystem is built for speed and high-performance applications.' },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'image', src: 'https://placehold.co/800x450.png', alt: 'A brain icon connected to a blockchain network', 'data-ai-hint': 'brain network', caption: 'The fusion of AI and Web3 creates a powerful synergy for building intelligent, decentralized systems.' },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'image', src: 'https://placehold.co/800x450.png', alt: 'A toolbox filled with various tools', 'data-ai-hint': 'toolbox tools', caption: 'The right set of tools is crucial for efficient and secure Web3 development.' },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'image', src: 'https://placehold.co/800x450.png', alt: 'A conductor leading an orchestra', 'data-ai-hint': 'conductor orchestra', caption: 'The Web3 PM orchestrates the complex interplay between technology, community, and product.' },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'image', src: 'https://placehold.co/800x450.png', alt: 'A dashboard showing various charts and graphs', 'data-ai-hint': 'data dashboard', caption: 'On-chain data provides a transparent and real-time view into the health of Web3 protocols.' },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'image', src: 'https://placehold.co/800x450.png', alt: 'A person speaking to an audience of developers', 'data-ai-hint': 'speaker audience', caption: 'DevRel professionals are the champions and supporters of the developer community.' },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'image', src: 'https://placehold.co/800x450.png', alt: 'A user interface design for a mobile app', 'data-ai-hint': 'app interface', caption: 'Designing for Web3 means creating intuitive interfaces for entirely new concepts.' },
