...
const articles: Article[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'blockquote', children: [{ type: 'p', children: [{ type: 'text', value: "By following this roadmap, you will not only acquire the necessary technical skills but also build a portfolio of projects that demonstrates your capabilities to potential employers.", style: 'italic' }] }] },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'blockquote', children: [{ type: 'p', children: [{ type: 'text', value: "The 'proof of work' needed to succeed in Web3 is not always about code, but about contribution, communication, and a deep understanding of the unique culture.", style: 'italic' }] }] },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'blockquote', children: [{ type: 'p', children: [{ type: 'text', value: "This is not a role for the faint of heart; it demands precision, paranoia, and a relentless pursuit of perfection. But for those who are passionate about security, it is an unparalleled opportunity to make a profound impact.", style: 'italic' }] }] },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'blockquote', children: [{ type: 'p', children: [{ type: 'text', value: "This guide will provide you with a comprehensive map of the DeFi career landscape, helping you find your place in the future of finance.", style: 'italic' }] }] },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'blockquote', children: [{ type: 'p', children: [{ type: 'text', value: "Whether you are an engineer passionate about building scalable consumer products, a curator with a keen eye for emerging talent, or a community builder, there is a place for you in the world of NFTs.", style: 'italic' }] }] },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'blockquote', children: [{ type: 'p', children: [{ type: 'text', value: "If you are a natural connector, a skilled communicator, and are passionate about the potential of decentralized technologies to bring people together, then a career in Web3 community management may be your calling.", style: 'italic' }] }] },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'blockquote', children: [{ type: 'p', children: [{ type: 'text', value: "In a world of hype and speculation, clarity is a superpower. As a technical writer, you have the opportunity to provide that clarity, empowering developers to build and users to understand.", style: 'italic' }] }] },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'blockquote', children: [{ type: 'p', children: [{ type: 'text', value: "In a world of decentralization, your community is your marketing team. This guide will show you how to build, nurture, and empower that community to tell your story for you.", style: 'italic' }] }] },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'blockquote', children: [{ type: 'p', children: [{ type: 'text', value: "This guide will equip you with the strategies and insights needed to break into the future of work.", style: 'italic' }] }] },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'blockquote', children: [{ type: 'p', children: [{ type: 'text', value: "This guide will provide you with the actionable steps needed to kickstart your career in the dynamic and exciting world of Web3.", style: 'italic' }] }] },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'blockquote', children: [{ type: 'p', children: [{ type: 'text', value: "This guide will outline the skills you need to acquire and the steps you can take to position yourself for a successful career in one of the most exciting and innovative sectors of the Web3 world.", style: 'italic' }] }] },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'blockquote', children: [{ type: 'p', children: [{ type: 'text', value: "If you are passionate about new forms of governance, community coordination, and the future of organizations, a career in DAO governance may be your calling.", style: 'italic' }] }] },
