...
- **Governance:** In many cases, holding the game's token also grants you voting rights in the game's [DAO (Decentralized Autonomous Organization)](/what-is-a-dao). This allows the community of players to have a real say in the future development and balancing of the game.
...
- **Scalability:** Blockchains can be slow. A fast-paced action game cannot wait for a transaction to be confirmed on the Ethereum mainnet. This is why most Web3 games are being built on high-performance [Layer 2s](/guide-to-layer-2s) or alternative blockchains.
