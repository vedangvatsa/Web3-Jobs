...
image: "https://images.unsplash.com/photo-1579567761406-4684ee0c75b6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxMXx8dGVjaHxlbnwwfHx8fDE3NTQ5NTU3OTJ8MA&ixlib=rb-4.1.0&q=80&w=1080"
...
### 1. What is an AMM?
An AMM, or Automated Market Maker, is a type of decentralized exchange (DEX) that allows for the automated, permissionless trading of crypto assets using liquidity pools instead of a traditional order book. It's a foundational primitive in **[DeFi](/what-is-defi)**.

### 2. How does an AMM work?
Most simple AMMs use a **constant product formula (`x * y = k`)**. The price of assets in a liquidity pool is determined algorithmically by the ratio of the two assets. When a trader swaps one asset for the other, the reserves change, and thus the price changes.

### 3. What is a Liquidity Provider (LP)?
A Liquidity Provider is a user who deposits their tokens into an AMM's liquidity pool. In return for providing this liquidity, they earn a share of the trading fees generated by the pool. This is a form of **[yield farming](/what-is-yield-farming)**.

### 4. What is Impermanent Loss?
Impermanent Loss is the primary risk for LPs. It's the potential loss an LP incurs due to price divergence between the two assets in the pool, compared to if they had just held the assets in their wallet.

### 5. Why build an AMM on a Layer 2?
Building on a **[Layer 2 network](/guide-to-layer-2s)** is crucial for AMMs because the lower gas fees and faster transaction speeds create a much better user experience for traders. High gas fees on a Layer 1 can make smaller trades economically unviable.
