...
export const article: Article = {
    ...
    image: '/images/non-technical-roles-in-crypto.png',
    ...
    content: [
      ...
      { type: 'p', children: [{ type: 'text', value: 'In Web3, a Product Manager decides the \'what\' and \'why\' of a decentralized product. They have to balance the needs of many different groups: users, token holders, developers, and the wider community. This role requires a unique ability to think about systems, incentives, and user experience all at once. We have a ' }, { type: 'link', href: '/articles/web3-product-manager-jobs', value: 'complete guide to Web3 product management' }, { type: 'text', value: ' to learn more.'}] },
      { type: 'h3', children: [{ type: 'text', value: 'Responsibilities:' }] },
      { type: 'ul', children: [
      ...
      { type: 'ul', children: [
        ...
        { type: 'li', children: [{ type: 'text', value: 'Data Analyst: Analyzing on-chain data to understand user behavior, protocol health, and market trends, giving critical insights to the product and leadership teams. Check out our ' }, { type: 'link', href: '/articles/crypto-data-analyst-jobs', value: 'guide to crypto data analyst jobs' }, { type: 'text', value: '.' }]},
        { type: 'li', children: [{ type: 'text', value: 'UX/UI Designer: Designing intuitive and user-friendly interfaces for dApps, which is a major challenge and a huge area of opportunity in Web3. Learn more in our ' }, { type: 'link', href: '/articles/web3-design-careers', value: 'Web3 design careers guide' }, { type: 'text', value: '.' }]},
      ]},
