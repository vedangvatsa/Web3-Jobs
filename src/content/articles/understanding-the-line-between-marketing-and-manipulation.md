...
It has a deeply corrosive effect on trust. It harms new retail investors, destroys the credibility of genuine projects, and invites negative regulatory scrutiny. Our deep dive on **[how shilling impacts Web3 trust](/how-crypto-shilling-impacts-web3-trust)** covers this in more detail.
...
The golden rule is **[DYOR (Do Your Own Research)](/what-is-dyor-in-crypto)**. Be skeptical of hype. Investigate the project's team, technology, and tokenomics yourself. Learn to read on-chain data to verify a project's claims about its user activity.
