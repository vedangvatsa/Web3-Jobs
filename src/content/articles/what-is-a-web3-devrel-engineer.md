...
The best way is to become an active and helpful member of a developer community. Start by building a project on a protocol you admire. Then, create content (like a tutorial or blog post) that fills a gap in their existing documentation. Your public contributions are the best way to get noticed by the core team. For a full overview, see our guide to **[the role of a DevRel in community building](/the-role-of-web3-developer-advocates-in-community-building)**.
