...
function resolveEventCoverImage(_cwd: string, img?: string | null): string | null {
...
/** Build-time only (Node precompute). Not imported by the Worker bundle. */
export async function buildEventsListing(): Promise<Web3Event[]> {
  try {
