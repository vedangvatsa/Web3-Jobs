...
function sourceQuality(job: Job): number {
  ...
  if (/^(greenhouse|lever|ashby|workable|recruitee|workday|smartrecruiters|breezy|bamboohr|comeet|teamtailor|rippling|dover|firstparty|superteam):/.test(source)) return 3;
