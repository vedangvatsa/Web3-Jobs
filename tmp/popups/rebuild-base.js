...
const files = Object.fromEntries(
  fs.readdirSync('public/popups').map(f => [f.replace(/\.[^.]+$/, ''), `/popups/${f}`])
);

function img(...keys) {
  for (const k of keys) if (files[k]) return files[k];
  return undefined;
}
...
const popups = [
  ...
  },
  {
    ...
    type: 'sez',
    themes: ['Crypto', 'Biotech', 'Robotics', 'SEZ'],
  ...
  },
  {
    ...
    location: 'Global',
    type: 'popup',
    themes: ['Science', 'Culture', 'Governance'],
  ...
  },
  {
    ...
    location: 'Global / UK',
    type: 'permanent',
    themes: ['Crypto', 'Governance', 'SEZ'],
    website: 'https://www.forma.city',
    image: img('forma'),
    foundedYear: 2024,
    residents: '100-500',
    sources: ['ns', 'xyz'],
    socials: { x: 'https://x.com/formacity' },
  ...
  },
  {
    ...
    type: 'popup',
    themes: ['Crypto', 'AI', 'Tech', 'Governance'],
    website: 'https://crecimiento.build',
    image: img('crecimiento', 'creci'),
    foundedYear: 2024,
    residents: '100-500',
    sources: ['ns', 'xyz'],
    socials: {
  ...
  },
  {
    ...
    type: 'permanent',
    themes: ['AI', 'Crypto', 'Biotech', 'Longevity'],
    website: 'https://frontiertower.io',
    image: img('frontiertower'),
    foundedYear: 2024,
    residents: '100-500',
    sources: ['ns', 'xyz'],
    socials: {
  ...
  },
  {
    ...
    type: 'permanent',
    themes: ['Tech', 'Culture', 'Governance'],
  ...
  },
  {
    ...
    type: 'permanent',
    themes: ['Tech', 'Culture', 'Biotech', 'Longevity'],
    website: 'https://zucity.org',
    image: img('zujapan'),
    foundedYear: 2024,
    residents: '100-500',
    sources: ['ns', 'xyz'],
  ...
  },
  {
    ...
    location: 'Japan',
    type: 'permanent',
    themes: ['Culture', 'Tech', 'Longevity'],
    website: 'https://www.akiyacollective.org',
    image: img('akiyacollective'),
    foundedYear: 2024,
    sources: ['ns'],
    socials: { x: 'https://x.com/AkiyaCollective' },
  ...
  },
  {
    ...
    location: 'Thailand',
    type: 'permanent',
    themes: ['Culture', 'Governance'],
    website: 'https://amagi.life',
    image: img('amagilife'),
    sources: ['ns'],
    socials: { x: 'https://x.com/AmagiLife' },
  ...
  },
  {
    ...
    type: 'permanent',
    themes: ['Tech', 'Governance', 'Business'],
    ...
    summary:
      'Arc accelerates the trajectory of people and places, delivering laws, capital, and talent on day one.',
    body: [
  ...
  },
  {
    ...
    image: img('arkpad'),
    sources: ['ns'],
    socials: { x: 'https://x.com/real_Arkpad' },
  ...
  },
  {
    ...
    location: 'Honduras',
    type: 'sez',
    themes: ['Business', 'Governance'],
    website: 'https://www.morazan.city',
    image: img('morazan'),
    sources: ['ns'],
    socials: { x: 'https://x.com/ciudadmorazan1' },
  ...
  },
  {
    ...
    image: img('commonshub'),
    sources: ['ns'],
    socials: { x: 'https://x.com/commonshubat' },
  ...
  },
  {
    ...
    image: img('culdesac'),
    sources: ['ns'],
    socials: { x: 'https://x.com/culdesac' },
  ...
  },
  {
    ...
    image: img('zuberlin'),
    sources: ['ns'],
    socials: { x: 'https://x.com/JoinFutura' },
  ...
  },
  {
    ...
    location: 'Bhutan',
    type: 'sez',
    themes: ['Governance', 'Business'],
    website: 'https://gmc.bt',
    image: img('gelephu'),
    sources: ['ns'],
    socials: { x: 'https://x.com/gmcbhutan' },
  ...
  },
  {
    ...
    image: img('hrg'),
    sources: ['ns'],
    socials: { x: 'https://x.com/HackerResidency' },
  ...
  },
  {
    ...
    location: 'Roatán, Honduras',
    type: 'permanent',
    themes: ['Biotech', 'Longevity', 'Tech'],
    website: 'https://www.infinita.city',
    image: img('infinita'),
    foundedYear: 2023,
    residents: '100-500',
    sources: ['ns', 'xyz'],
    socials: { x: 'https://x.com/infinitacity' },
  ...
  },
  {
    ...
    type: 'popup',
    themes: ['Crypto', 'Tech', 'Governance', 'AI'],
    website: 'https://www.ipe.city',
    image: img('ipecity'),
    foundedYear: 2023,
    residents: '100-500',
    sources: ['ns', 'xyz'],
  ...
  },
  {
    ...
    image: img('mountaindao'),
    sources: ['ns'],
    socials: { x: 'https://x.com/mtndao' },
  ...
  },
  {
    ...
    image: img('nomacollective'),
    sources: ['ns'],
    socials: { x: 'https://x.com/noma_collective' },
  ...
  },
  {
    ...
    image: img('nomad'),
    sources: ['ns'],
    socials: { x: 'https://x.com/NOMADcoliving' },
  ...
  },
  {
    ...
    image: img('prototown'),
    sources: ['ns'],
    socials: { x: 'https://x.com/Proto_Town' },
  ...
  },
  {
    ...
    image: img('rnsid'),
    sources: ['ns'],
    socials: { x: 'https://x.com/RNS_global' },
  ...
  },
  {
    ...
    location: 'Global',
    type: 'popup',
    themes: ['Crypto', 'AI', 'Tech'],
    website: 'https://www.shanhaiwoo.com',
    image: img('shanhaiwoo'),
    foundedYear: 2023,
    residents: '100-500',
    sources: ['ns', 'xyz'],
    socials: {
  ...
  },
  {
    ...
    image: img('starbase'),
    sources: ['ns'],
    socials: { x: 'https://x.com/StarbaseTX' },
  ...
  },
  {
    ...
    location: 'Portugal',
    type: 'permanent',
    themes: ['Crypto', 'Culture'],
    website: 'https://www.traditionaldreamfactory.com',
    image: img('traditionaldreamfactory'),
    sources: ['ns'],
    socials: { x: 'https://x.com/tdfinyourdreams' },
  ...
  },
  {
    ...
    image: img('vibecamp'),
    sources: ['ns'],
    socials: { x: 'https://x.com/vibecamp_' },
  ...
  },
  {
    ...
    type: 'popup',
    themes: ['Tech', 'Science', 'Crypto', 'Public Goods'],
  ...
  },
  {
    ...
    type: 'popup',
    themes: ['Tech', 'Crypto', 'Public Goods', 'Culture'],
    website: 'https://zuafrique.com',
    image: img('zuafrique'),
    foundedYear: 2024,
    residents: '25-100',
    sources: ['ns', 'xyz'],
    socials: { x: 'https://x.com/zuAfrique' },
  ...
  },
  {
    ...
    type: 'popup',
    themes: ['Tech', 'Biotech', 'Governance', 'Crypto', 'AI'],
    website: 'https://zuitzerland.ch',
    image: img('zuitzerland'),
    foundedYear: 2024,
    residents: '100-500',
    sources: ['ns', 'xyz'],
    socials: {
  ...
  },
  {
    ...
    location: 'Kaş, Turkey',
    type: 'popup',
    themes: ['Governance', 'Crypto', 'Longevity'],
    website: 'https://zukascity.com',
    image: img('zukas'),
    foundedYear: 2025,
    residents: '100-500',
    sources: ['ns', 'xyz'],
    socials: { x: 'https://x.com/zuzalukas' },
  ...
  },
  {
    ...
    type: 'popup',
    themes: ['Governance', 'Tech', 'Crypto'],
    website: 'https://zuzalu.city',
    image: img('zuzalu'),
    foundedYear: 2023,
    residents: '100-500',
    sources: ['ns', 'xyz'],
    socials: { x: 'https://x.com/Zuzalu_city' },
  ...
  },
  {
    ...
    type: 'permanent',
    themes: ['Crypto', 'AI', 'Biotech'],
    website: 'https://praxisnation.com',
    image: img('praxis'),
    foundedYear: 2019,
    residents: '2500-10000',
    sources: ['xyz'],
    socials: {
  ...
  },
  {
    ...
    type: 'popup',
    themes: ['Crypto', 'AI', 'Tech', 'Public Goods'],
  ...
  },
  {
    ...
    type: 'digital',
    themes: ['Tech', 'Crypto', 'Governance', 'Culture'],
  ...
  },
  {
    ...
    type: 'popup',
    themes: ['Crypto', 'AI', 'Robotics'],
    website: 'https://web3villages.com',
    image: img('w3v'),
    foundedYear: 2022,
    residents: '100-500',
    sources: ['xyz'],
  ...
  },
  {
    ...
    type: 'permanent',
    themes: ['AI', 'Tech', 'Business', 'Culture'],
  ...
  },
  {
    ...
    residents: '100-500',
    sources: ['xyz'],
    socials: { x: 'https://x.com/ethiopia____' },
  ...
  },
  {
    ...
    type: 'popup',
    themes: ['Culture', 'Tech', 'Governance'],
    website: 'https://arrayah.city',
    image: img('ary'),
    foundedYear: 2024,
    residents: '25-100',
    sources: ['xyz'],
    socials: { x: 'https://x.com/_Arrayah' },
  ...
  },
  {
    ...
    type: 'popup',
    themes: ['Crypto', 'AI', 'Tech', 'Business'],
    website: 'https://theozcity.com',
    image: img('oz'),
    foundedYear: 2025,
    residents: '25-100',
    sources: ['xyz'],
  ...
  },
  {
    ...
    type: 'sez',
    themes: ['Longevity', 'Biotech', 'AI', 'Crypto', 'Governance'],
  ...
  },
  {
    ...
    type: 'popup',
    themes: ['Governance', 'Tech', 'Biotech'],
    website: 'https://netxstate.com',
    image: img('netx'),
    foundedYear: 2024,
    residents: '25-100',
    sources: ['xyz'],
  ...
  },
  {
    ...
    location: 'Various',
    type: 'digital',
    themes: ['Tech', 'Business', 'Governance', 'SEZ'],
    website: 'https://alphacity.io',
    image: img('ac'),
    foundedYear: 2024,
    residents: '0-25',
    sources: ['xyz'],
    socials: { x: 'https://x.com/alphacityinc' },
  ...
  },
  {
    ...
    type: 'permanent',
    themes: ['Business', 'Tech', 'Governance', 'Culture'],
  ...
  },
  {
    ...
    type: 'sez',
    themes: ['SEZ', 'Tech', 'Business'],
    website: 'https://itana.africa',
    image: img('itana'),
    foundedYear: 2023,
    residents: '100-500',
    sources: ['xyz'],
    socials: { x: 'https://x.com/itanaafrica' },
...
const slugs = popups.map(p=>p.slug);
const dup = slugs.filter((s,i)=>slugs.indexOf(s)!==i);
if (dup.length) throw new Error('dup slugs '+dup);
require('fs').writeFileSync('tmp/popups/base-popups.json', JSON.stringify(popups, null, 2));
console.log('wrote', popups.length);
